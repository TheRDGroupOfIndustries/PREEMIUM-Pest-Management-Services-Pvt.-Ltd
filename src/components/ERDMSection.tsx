      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-4xl mx-auto">
          {steps.map((step, i) => (
            ...
            >
              <div className="shrink-0 w-16 h-16 bg-gradient-primary rounded-xl flex items-center justify-center shadow-elevated">
                <span className="font-heading text-2xl font-bold text-primary-foreground">{step.letter}</span>
              </div>
              <div className="bg-background rounded-xl p-6 flex-1 shadow-card border border-border/50">
