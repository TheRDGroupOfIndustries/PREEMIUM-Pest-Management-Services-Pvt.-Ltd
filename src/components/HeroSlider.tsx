...
const slides = [
  {
    image: hero1,
    headline: "India's Trusted Professional Pest Management Experts",
    subheadline: "Science-driven, eco-friendly pest management for homes, industries, and businesses",
  },
  {
    image: hero2,
