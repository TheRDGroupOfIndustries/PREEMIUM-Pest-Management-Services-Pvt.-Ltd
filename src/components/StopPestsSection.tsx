                        ...
                        <motion.div variants={itemVariants} className="bg-primary/5 border border-primary/20 rounded-xl p-5 mt-2 hover-lift">
                            <div className="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground mb-1.5"><strong className="text-foreground font-medium">Varanasi Office:</strong>Near Mahavir Mandir, Varanasi, Uttar Pradesh, India</p>
                                </div>
                            </div>
                        </motion.div>
