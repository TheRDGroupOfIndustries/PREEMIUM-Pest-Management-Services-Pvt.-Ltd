...
export const servicesData: ServiceData[] = [
    {
        ...
        seoTitle: "General Pest Management in Varanasi | Ants, Cockroach, Silverfish Control",
        seoDescription: "Book general pest management in Varanasi for ants, cockroaches, spiders, silverfish and common household pests using safe approved chemicals.",
        icon: Bug,
    ...
    },
    {
        ...
        seoTitle: "Termite Treatment in Varanasi | Pre & Post Construction Anti-Termite",
        seoDescription: "Protect your Varanasi property from termites with pre-construction soil treatment, post-construction drill-and-fill, wood treatment and baiting systems.",
        icon: Target,
    ...
    },
    {
        ...
        seoDescription: "Professional mosquito and fly management in Varanasi with source reduction, larvicide, adulticide, fogging, barrier sprays and hygiene-focused control.",
        icon: Waves,
    ...
    },
    {
        ...
        seoTitle: "Bed Bug Treatment in Varanasi | Heat and Chemical Elimination",
        seoDescription: "Book bed bug treatment in Varanasi with specialized heat treatment, steam, chemical treatment and warranty-backed elimination for homes, hotels and hostels.",
        icon: ShieldAlert,
    ...
    },
    {
        ...
        seoTitle: "Commercial Fumigation in Varanasi | Warehouse, Commodity, Export",
        seoDescription: "Commercial fumigation in Varanasi for warehouses, commodities, containers, food storage, textile warehouses and export packaging with certificates.",
        icon: Flame,
    ...
    },
    {
        ...
        seoTitle: "Bird Control Services in Varanasi | Netting, Spikes, Wire Systems",
    ...
    },
    {
        ...
        seoTitle: "Garden Pest Management in Varanasi | Kitchen Garden Pest Control",
        seoDescription: "Garden pest management in Varanasi for kitchen gardens, vegetable beds, flower beds and ornamentals using IPM and bee-safe treatments.",
        icon: Flower2,
